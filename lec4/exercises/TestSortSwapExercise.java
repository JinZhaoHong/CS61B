...
public class TestSortSwapExercise {
    ...
    public static void testSwap() {
        ...
        SortSwapExercise.swap(input, 1, 3);
    ...
    public static void testIndexOfSmallest() {
        String[] input = {"a" , "pig", "dreamt", "nothing"};
        int actual = SortSwapExercise.indexOfSmallest(input, 0);
        int expected = 0;

        org.junit.Assert.assertEquals(expected, actual);

        actual = SortSwapExercise.indexOfSmallest(input, 1);
        expected = 2;
