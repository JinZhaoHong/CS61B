...
public class FibonacciMemo {
    ...
    private static HashMap<Integer, Integer> fibMemoMap = new HashMap<Integer, Integer>();
    ...
    public static int fibMemo(int n) {
        ...
        if (fibMemoMap.containsKey(n)) {
            return fibMemoMap.get(n);
        }
        fibMemoMap.put(n, fibNoMemo(n - 2) + fibNoMemo(n - 1));
        return fibMemoMap.get(n);
    }
