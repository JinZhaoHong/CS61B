...
public class GenericList <Oop> {
    ...
    public void insert(Oop val) {
        head = new Node(val, head);
        length += 1;
    }

    /** The head of this linked list. */
    private Node<Oop> head;
