...
public class TestTimeSeries{
	...
	public void ComprehensiveTest() {
        ...
        assertEquals(10, tSum.get(1991), 0.01);
        assertEquals(-1.4, tSum.get(1992), 0.01);
    ...
    public void checkYearAndData() {
        ...
        Collection<Number> c = ts.data();
        for (Number n : c) {
            System.out.println("this is the data: " + n);
        }

        Collection<Number> yr = ts.years();
        for (Number n : yr) {
            System.out.println("this is the year " + n);
