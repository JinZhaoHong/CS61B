This exercise was never actually created, but hey if you want to play around with hidden variables, here's a place to start (though I'd recommend just doing HW3 instead).
